...
class UFOs():
  ...
  def create_fleet(self):
    self.fire_every_counter = 0
    ufo = UFO(self.game, row=0, ufo_no=-1)
  ...
  def update(self):
    ...
    # update the positions of all of the ufos' lasers (the ship updates its own lasers)
    self.lasers.update()
